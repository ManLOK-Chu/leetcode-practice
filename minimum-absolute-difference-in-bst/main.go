...
func main() {
	fmt.Println(getMinimumDifference(arrayToTreeNode([]int{4, 2, 6, 1, 3})))
	fmt.Println(getMinimumDifference(arrayToTreeNode([]int{1, 0, 48, null, null, 12, 49})))
	fmt.Println(getMinimumDifference(arrayToTreeNode([]int{90, 69, null, 49, 89, null, 52})))
}
